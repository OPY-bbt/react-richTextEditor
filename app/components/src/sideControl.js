	...
	render() {
		return (
			<div className="container" style={this.props.style}>
				...
				<div 
	              	className	=	{
	              		this.props.currentInlineStyle && this.props.currentInlineStyle.has('ITALIC') 
				...
				<div
					className={"ulSelected"}
					onMouseDown = {
						(e) => {
							e.preventDefault();
							this.props.toggledFontSize()
						}
					}
				>
				</div>
